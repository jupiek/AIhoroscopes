...
recombine = function (list) {
  ...
  elements = unlist(strsplit(list[[1]], "\\. "))
  for (i in 1:length(elements)) {elements[i] = paste(elements[i], ".", sep = "")}
  
  paths = vector(length = 3)
  for (i in 1:3) {
    #paths[i] = paste("imgs/", list[[2]], ".", as.character(i), ".png", sep = "")
  }
  paths = c("img_1.1.png", "img_1.2.png", "img_1.3.png")
...
h = generate(data, "Leo", "Monday")
strsplit(h[[1]], "\\. ")
recombine(h)
h[[2]]
list("a", 1)
readImage("imgs/img_1.png")
```
